 ...
 * Pada strategi ini, setiap sel pada papan anak dipilih secara acak dari salah satu orang tua
...
public class UniformCrossover implements CrossoverStrategy {
    ...
    public Individual crossover(Individual parent1, Individual parent2, Random rng) {
        // Membuat copy dari parent1 sebagai anak (yang nantinya beberapa sel akan diganti dari parent2)
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < cols; c++) {
                ...
                if(!child.isFixed(r, c)) {
                    // Dengan peluang 50%, ganti value sel dengan value dari sel dengan koordinat yang sama pada parent2
                    if (rng.nextBoolean()) {
